...
public partial class GoogleDocumentsEditorMenu
{
    ...
    //[MenuItem(MENU_ITEM + "Update All Documents")]
    //static public void UpdateAllDocuments()
    //{
    ...
    //    string[] guids = AssetDatabase.FindAssets("t:GoogleDocumentLink", null);
    //    foreach (string guid in guids)
    //    {
    //        GoogleDocumentLink spreadsheet = AssetDatabase.LoadMainAssetAtPath(AssetDatabase.GUIDToAssetPath(guid)) as GoogleDocumentLink;
    //        if (spreadsheet != null)
    //        {
    ...
    [MenuItem(CREATE_MENU_ITEM + "Raw Google Document")]
    static public void CreateRawGoogleDocumentObject()
    {
        ScriptableObjectUtility.CreateAsset<RawGoogleDocumentObject>();
    }
    ...
    [MenuItem(CREATE_MENU_ITEM + "Link/Google Spread Sheet Scriptable Object")]
    static public void CreateGoogleDocumentRawLink()
    {
        ScriptableObjectUtility.CreateAsset<GoogleDocumentRaw>().OnCreate();
    }
}
