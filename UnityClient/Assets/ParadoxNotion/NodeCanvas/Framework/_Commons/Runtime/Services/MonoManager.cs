...
namespace ParadoxNotion.Services {
    ...
    public class MonoManager : MonoBehaviour {
        ...
        private static int i; //used for iterators
        ...
        public void Update(){
            ...
            for (i = 0; i < onUpdateCalls.Count; i++){
                onUpdateCalls[i]();
            }
        ...
        public void LateUpdate(){
            ...
            for (i = 0; i < onLateUpdateCalls.Count; i++){
                onLateUpdateCalls[i]();
            }
        ...
        public void FixedUpdate(){
            ...
            for (i = 0; i < onFixedUpdateCalls.Count; i++){
