...
abstract public class GoogleDocumentLink : ScriptableObject
{
    ...
    {
        GoogleDocumentsUpdater updater = new GoogleDocumentsUpdater();
        updater.OnUpdateComplete += delegate { updater = null; };
        updater.UpdateGoogleDocuments(new List<GoogleDocumentLink> { this });
    }
